...
- [DSVVA/MHY_Scanner](https://github.com/DSVVA/MHY_Scanner), GPL-3.0: corroborated the public `nap_cn` QR endpoint naming. No source code is copied into this MIT-licensed directory.
